...
class UserListPage extends Component<allProps> {
  ...
  componentDidMount() {
    ...
    this.unlisten = this.props.history.listen((location, action) => {
      ...
      if(! (location.pathname === '/users' || location.pathname === '/users/')) return;
  ...
  render() {
    return (
      <div>
        ...
        <UsersPagination pagePrevUserId={this.props.pagePrevUserId} pageNextUserId={this.props.pageNextUserId}/>
      </div>
    );
  }
}
